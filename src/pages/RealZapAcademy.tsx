      ...
      <section ref={heroRef} className="relative py-20 md:py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <div className="text-base md:text-lg text-gray-200 max-w-2xl mx-auto mb-8 leading-relaxed space-y-2 flex flex-col items-center">
            ...
            <p className="inline-block rounded-md" style={{ background: "rgba(0,0,0,0.5)", padding: "4px 12px", textShadow: "0 1px 4px rgba(0,0,0,0.8)" }}>🎯 Criativos que não esgotam na escala</p>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <a href={checkoutUrl} target="_blank" rel="noopener noreferrer">
            <Button
              ...
              style={{ backgroundColor: GREEN }}
            >
              🔥 Quero acessar o Real Zap Academy — R$397
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </a>
