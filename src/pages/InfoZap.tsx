...
const mechanismBenefits = [
  ...
  { emoji: "📈", title: "De zero a R$1.000/dia em menos de 1 mês", desc: "A operação é rápida e altamente escalável. Com o método completo, alunos saem do zero e chegam a 1k por dia em menos de 30 dias." },
];
...
const baseModules = [
  { num: "01", title: "Bem-vindo ao InfoZap", subs: ["Como funciona a operação completa de lowticket no WhatsApp", "Exemplo real do funil rodando", "Mapa da jornada do zero ao primeiro Pix"] },
...
const faqs = [
  { q: "Preciso ter experiência pra comprar?", a: "Não. O InfoZap foi feito pra quem está começando do zero e pra quem já vende e quer escalar. O método cobre os dois casos do início ao fim." },
  ...
  { q: "Precisa de site ou plataforma cara?", a: "Não. A operação inteira roda com WhatsApp + ZapData. Sem site, sem plataforma de curso, sem estoque." },
      ...
      <section ref={heroRef} className="relative py-20 md:py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <div className="text-base md:text-lg text-gray-200 max-w-2xl mx-auto mb-8 leading-relaxed space-y-2 flex flex-col items-center">
            ...
            <p className="inline-block rounded-md" style={{ background: "rgba(0,0,0,0.5)", padding: "4px 12px", textShadow: "0 1px 4px rgba(0,0,0,0.8)" }}>🎯 Estrutura de Tráfego completa e infalível</p>
                  ...
                  <CarouselItem key={index} className="pl-3 md:pl-4 basis-[70%] sm:basis-1/2 md:basis-1/3 lg:basis-1/4">
                    <div className="relative group cursor-pointer">
                      <div className="aspect-[2/3] overflow-hidden rounded-xl border-2 border-border/50 group-hover:border-primary/70 transition-all duration-300 shadow-lg group-hover:shadow-[0_0_30px_hsl(330_85%_65%_/_0.4)]">
                        <img src={mod.image} alt={mod.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" />
                      </div>
                    </div>
                  </CarouselItem>
                ))}
      ...
      <section className="py-12 px-4">
        <div className="max-w-3xl mx-auto rounded-xl p-8 border" style={{ backgroundColor: "rgba(255,200,0,0.04)", borderColor: "rgba(255,200,0,0.3)" }}>
          ...
          <div className="text-gray-400 text-sm leading-relaxed space-y-4">
            ...
            <p>Nos dois casos o custo de continuar sem o método completo é muito maior do que R$67. Você já gastou mais do que isso em modelo que não funcionou, em anúncio que não converteu, em curso que não entregou.</p>
            <p>Por R$67 você tem acesso ao método completo — do zero ao avançado — numa operação só. Sem precisar comprar mais nada depois. Sem lacuna. Sem próximo nível.</p>
            <p className="font-bold text-white">O custo de continuar sem isso é muito maior do que R$67.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="max-w-3xl mx-auto rounded-xl p-8 border" style={{ borderColor: "rgba(255,45,120,0.3)", backgroundColor: "rgba(255,45,120,0.04)" }}>
          ...
          <p className="text-gray-500 text-sm">
            Se você está disposto a dedicar tempo, seguir o passo a passo e colocar em prática — seja você iniciante ou quem já vende — o InfoZap foi feito pra você.
          </p>
        </div>
      </section>
