...
import { ArrowLeft, Loader2, Trash2, KeyRound, Shield, ShieldOff, Check, X } from "lucide-react";
          ...
          <div className="overflow-x-auto border border-white/10 rounded-lg">
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                {users.length === 0 && !busy && (
                  <tr><td colSpan={6} className="px-3 py-10 text-center text-gray-500">Nenhum usuário.</td></tr>
                )}
              </tbody>
            </table>
          </div>
