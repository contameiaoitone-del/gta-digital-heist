...
export const Hero = () => {
  ...
  return (
    <section className="relative flex overflow-hidden items-start justify-start pt-12 pb-12 md:min-h-screen md:items-center md:justify-center md:pt-8 md:pb-12">
