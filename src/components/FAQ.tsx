...
export const FAQ = () => {
  return <section className="relative py-16 sm:py-20 md:py-32 overflow-hidden bg-card/10">
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border-2 border-border bg-card/50 backdrop-blur-sm rounded-lg overflow-hidden hover:border-primary/50 transition-all duration-300 data-[state=open]:border-primary data-[state=open]:shadow-soft-pink">
